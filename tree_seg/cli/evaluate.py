...
def evaluate_command(
    ...
    clustering: Literal["kmeans", "gmm", "spectral", "hdbscan", "spherical", "dpmeans"] = typer.Option(
        "kmeans",
        "--clustering",
        "-c",
        help="Clustering algorithm: kmeans (default), gmm, spectral, hdbscan, spherical (cosine k-means), dpmeans (auto-K)",
    ),
