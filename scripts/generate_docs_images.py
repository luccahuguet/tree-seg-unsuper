...
def organize_images():
    ...
    (docs_results / "parameter_comparison" / "stride").mkdir(
        parents=True, exist_ok=True
    )
    (docs_results / "parameter_comparison" / "model_size").mkdir(
        parents=True, exist_ok=True
    )
    (docs_results / "parameter_comparison" / "elbow_threshold").mkdir(
        parents=True, exist_ok=True
    )
    (docs_results / "parameter_comparison" / "refinement").mkdir(
        parents=True, exist_ok=True
    )
    ...
    mappings = [
        ...
        # Stride comparison (web-optimized)
        {
            ...
            "files": {"*_edge_overlay.jpg": "stride_comparison_str2_edge_overlay.jpg"},
        },
        {
            "source": "stride_comparison_str4/web",
            "target": "parameter_comparison/stride",
            "files": {"*_edge_overlay.jpg": "stride_comparison_str4_edge_overlay.jpg"},
        },
        # Model size comparison (web-optimized)
        {
            "source": "model_comparison_small/web",
            "target": "parameter_comparison/model_size",
            "files": {"*_edge_overlay.jpg": "model_comparison_small_edge_overlay.jpg"},
        },
        {
            "source": "model_comparison_base/web",
            "target": "parameter_comparison/model_size",
            "files": {"*_edge_overlay.jpg": "model_comparison_base_edge_overlay.jpg"},
        },
        {
            "source": "model_comparison_large/web",
            "target": "parameter_comparison/model_size",
            "files": {"*_edge_overlay.jpg": "model_comparison_large_edge_overlay.jpg"},
        },
        {
            "source": "model_comparison_giant/web",
            "target": "parameter_comparison/model_size",
            "files": {"*_edge_overlay.jpg": "model_comparison_giant_edge_overlay.jpg"},
        },
        # Elbow threshold comparison (web-optimized) - 2x2 grid
        {
            ...
            "files": {"*_edge_overlay.jpg": "elbow_threshold_2_5_edge_overlay.jpg"},
        },
        {
        ...
        },
        {
            ...
            "target": "parameter_comparison/elbow_threshold",
            "files": {"*_edge_overlay.jpg": "elbow_threshold_10_0_edge_overlay.jpg"},
        },
        {
            "source": "elbow_threshold_20_0/web",
            "target": "parameter_comparison/elbow_threshold",
            "files": {"*_edge_overlay.jpg": "elbow_threshold_20_0_edge_overlay.jpg"},
        },
        # Refinement comparison (web-optimized)
        {
            "source": "refine_with_slic/web",
            "target": "parameter_comparison/refinement",
            "files": {"*_edge_overlay.jpg": "refine_with_slic_edge_overlay.jpg"},
        },
        {
            "source": "refine_none/web",
            "target": "parameter_comparison/refinement",
            "files": {"*_edge_overlay.jpg": "refine_none_edge_overlay.jpg"},
        },
    ]
...
def main():
    ...
    print(
        "  📊 Elbow Threshold Comparison - 2.5%, 5.0%, 10.0%, 20.0% thresholds (2x2 grid)"
    )
